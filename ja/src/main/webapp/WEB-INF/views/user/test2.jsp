		...
		<div id="modal" class="modal-overlay" style="display:none">
			<div class="modal-window">
				<div class="modalBox">
					...
					<!-- Form 태그 시작 -->
					<form id="regUserInfo" name="regUser">
					<div class="top">
					...
					<div class="btnBox">
						<input type="submit" name="" value="등록" class="btnBoxbtn" onclick="registerUser()">
