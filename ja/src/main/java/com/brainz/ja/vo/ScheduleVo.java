...
public class ScheduleVo {
	...
	public ScheduleVo(int sc_no, int user_no, String title, LocalDate start_date, LocalTime start_time,
			LocalDate end_date, LocalTime end_time, int repeat_cat, int repeat_day, int repeat_week, String mon,
			String the, String wed, String thu, String fri, String sat, String sun, LocalDateTime write_date,
	...
	public int getRepeat_cat() {
		return repeat_cat;
	}
	public void setRepeat_cat(int repeat_cat) {
		this.repeat_cat = repeat_cat;
	}
