...
public class ServerVo {
	...
	public ServerVo(Integer server_no, Integer user_no, String name, String ip, String os, String status, String loc,
			String mac, String control_num, String dsc, LocalDateTime write_date, Integer count) {
		super();
